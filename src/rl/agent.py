...
class RLTradingAgent:
    ...
    def __init__(self, state_size, action_size, model_path=None):
        ...
        self.action_size = action_size  # Tamanho do espaço de ações (comprar, vender, manter)
        self.memory = deque(maxlen=2000)  # Memória de replay para experiências passadas
        ...
        if model_path and os.path.exists(model_path):
            ...
            self.epsilon = self.epsilon_min  # Reduzir exploração se já temos um modelo treinado
    ...
    def _build_model(self):
        ...
        model.add(Dense(self.action_size, activation='linear'))  # Saída: Q-values para cada ação
    ...
    def load_model(self, path):
        ...
        self.epsilon = self.epsilon_min  # Reduz exploração após carregar modelo treinado